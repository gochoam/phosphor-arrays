...
describe('phosphor-arrays', () => {
  ...
  describe('forEach()', () => {
    ...
    it('should return the first value returned by the callback', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.forEach(data, v => { });
      let r2 = arrays.forEach(data, v => v);
      let r3 = arrays.forEach(data, v => { }, 2, true);
      let r4 = arrays.forEach(data, v => v, 2, true);
    ...
    it('should terminate iteration when the callback returns a value', () => {
      let data = [1, 2, 3, 4, 5];
      let values: number[] = [];
      let r = arrays.forEach(data, v => { values.push(v); if (v > 3) return v; });
  ...
  describe('rforEach()', () => {
    ...
    it('should return the first value returned by the callback', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.rforEach(data, v => { });
      let r2 = arrays.rforEach(data, v => v);
      let r3 = arrays.rforEach(data, v => { }, 2, true);
      let r4 = arrays.rforEach(data, v => v, 2, true);
      expect(r1).to.be(void 0);
      expect(r2).to.be(5);
      expect(r3).to.be(void 0);
      expect(r4).to.be(3);
    ...
    it('should terminate iteration when the callback returns a value', () => {
      let data = [1, 2, 3, 4, 5];
      let values: number[] = [];
      let r = arrays.rforEach(data, v => { values.push(v); if (v < 3) return v; });
  ...
  describe('findIndex()', () => {
    ...
    it('should find the index of the first value matching a predicate', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.findIndex(data, v => v % 2 === 0);
      expect(i).to.be(1);
    });

    it('should support iterating from a start index', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.findIndex(data, v => v % 2 === 0, 2);
      expect(i).to.be(3);
    });

    it('should support wrapping at the end of the array', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.findIndex(data, v => v % 3 === 0, 3, true);
      expect(i).to.be(2);
    });

    it('should return `-1` if no value matches the predicate', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.findIndex(data, v => v % 7 === 0);
      expect(i).to.be(-1);
    });

    it('should return `-1` if `fromIndex` is out of range', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.findIndex(data, v => v % 2 === 0, -1);
      let r2 = arrays.findIndex(data, v => v % 2 === 0, 10);
      expect(r1).to.be(-1);
      expect(r2).to.be(-1);
    });
  ...
  describe('rfindIndex()', () => {
    ...
    it('should find the index of the last value matching a predicate', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.rfindIndex(data, v => v % 2 === 0);
      expect(i).to.be(3);
    });

    it('should support iterating from a start index', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.rfindIndex(data, v => v % 2 === 0, 2);
      expect(i).to.be(1);
    });

    it('should support wrapping at the front of the array', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.rfindIndex(data, v => v % 3 === 0, 1, true);
      expect(i).to.be(2);
    });

    it('should return `-1` if no value matches the predicate', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.rfindIndex(data, v => v % 7 === 0);
      expect(i).to.be(-1);
    });

    it('should return `-1` if `fromIndex` is out of range', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.rfindIndex(data, v => v % 2 === 0, -1);
      let r2 = arrays.rfindIndex(data, v => v % 2 === 0, 10);
      expect(r1).to.be(-1);
      expect(r2).to.be(-1);
    });
  ...
  describe('find()', () => {
    ...
    it('should find the first value matching a predicate', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.find(data, v => v % 2 === 0);
      expect(i).to.be(2);
    });

    it('should support iterating from a start index', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.find(data, v => v % 2 === 0, 2);
      expect(i).to.be(4);
    });

    it('should support wrapping at the end of the array', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.find(data, v => v % 3 === 0, 3, true);
      expect(i).to.be(3);
    });

    it('should return `undefined` if no value matches the predicate', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.find(data, v => v % 7 === 0);
  ...
  describe('rfind()', () => {
    ...
    it('should find the last value matching a predicate', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.rfind(data, v => v % 2 === 0);
      expect(i).to.be(4);
    });

    it('should support iterating from a start index', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.rfind(data, v => v % 2 === 0, 2);
      expect(i).to.be(2);
    });

    it('should support wrapping at the front of the array', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.rfind(data, v => v % 3 === 0, 1, true);
      expect(i).to.be(3);
    });

    it('should return `undefined` if no value matches the predicate', () => {
      let data = [1, 2, 3, 4, 5];
      let i = arrays.rfind(data, v => v % 7 === 0);
      expect(i).to.be(void 0);
    });
  ...
  describe('insert()', () => {
    ...
    it('should return the index at which the element was inserted', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.insert(data, 0, 6);
      let r2 = arrays.insert(data, 9, 7);
      let r3 = arrays.insert(data, 4, 8);
  ...
  describe('move()', () => {
    ...
    it('should return `true` if the move was successful', () => {
      let data = [1, 2, 3, 4, 5];
      let r = arrays.move(data, 1, 2);
      expect(r).to.be(true);
    });

    it('should return `false` if either index is out of range', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.move(data, -1, 4);
      let r2 = arrays.move(data, 2, 10);
      let r3 = arrays.move(data, -4, 9);
  ...
  describe('removeAt()', () => {
    ...
    it('should return the removed value', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.removeAt(data, 1);
      let r2 = arrays.removeAt(data, 3);
      let r3 = arrays.removeAt(data, 0);
      expect(r1).to.be(2);
      expect(r2).to.be(5);
      expect(r3).to.be(1);
    });
    ...
    it('should return `undefined` if the index is out of range', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.removeAt(data, -3);
      let r2 = arrays.removeAt(data, 10);
      expect(r1).to.be(void 0);
  ...
  describe('remove()', () => {
    ...
    it('should return the index occupied by the value', () => {
      let data = [1, 2, 3, 4, 5];
      let r1 = arrays.remove(data, 1);
      let r2 = arrays.remove(data, 3);
      let r3 = arrays.remove(data, 5);
      expect(r1).to.be(0);
      expect(r2).to.be(1);
      expect(r3).to.be(2);
    });
  ...
  describe('lowerBound()', () => {
    ...
    it('should return the index of the first element `>=` a value', () => {
      ...
      let r1 = arrays.lowerBound(data, -5, lt);
      let r2 = arrays.lowerBound(data, 0, lt);
      let r3 = arrays.lowerBound(data, 3, lt);
      let r4 = arrays.lowerBound(data, 5, lt);
      expect(r1).to.be(0);
      expect(r2).to.be(0);
      expect(r3).to.be(3);
      expect(r4).to.be(6);
    ...
    it('should return `array.length` if there is no qualifying value', () => {
      let data = [1, 2, 2, 3, 3, 4, 5, 5];
      let lt = (a: number, b: number) => a < b;
      let r1 = arrays.lowerBound(data, 9, lt);
      let r2 = arrays.lowerBound(data, 19, lt);
      let r3 = arrays.lowerBound(data, 29, lt);
      expect(r1).to.be(8);
      expect(r2).to.be(8);
      expect(r3).to.be(8);
    });
  ...
  describe('upperBound()', () => {
    ...
    it('should return the index of the first element `>` a value', () => {
      let data = [1, 2, 2, 3, 3, 4, 5, 5];
      let lt = (a: number, b: number) => a < b;
      let r1 = arrays.upperBound(data, -5, lt);
      let r2 = arrays.upperBound(data, 0, lt);
      let r3 = arrays.upperBound(data, 2, lt);
      let r4 = arrays.upperBound(data, 3, lt);
      expect(r1).to.be(0);
      expect(r2).to.be(0);
      expect(r3).to.be(3);
      expect(r4).to.be(5);
    ...
    it('should return `array.length` if there is no qualifying value', () => {
      let data = [1, 2, 2, 3, 3, 4, 5, 5];
      let lt = (a: number, b: number) => a < b;
      let r1 = arrays.upperBound(data, 9, lt);
      let r2 = arrays.upperBound(data, 19, lt);
      let r3 = arrays.upperBound(data, 29, lt);
      expect(r1).to.be(8);
      expect(r2).to.be(8);
      expect(r3).to.be(8);
    });
